...
<div class="containers">
	...
	<div class="right_part">
		...
		<div class="right_part_cell"><span class='title'>发货日期:</span><span><input id="merchandise_date" type="text" value="" /></span>(例如:1900-01-01)</div>
		...
		<div class="right_part_cell"><span class='title'>货物重量:</span><span><input id="merchandise_weight" type="text" value="" /></span>吨</div>
		<div class="right_part_cell"><span class='title'>货物体积:</span><span><input id="merchandise_volume" type="text" value="" /></span>立方米</div>
